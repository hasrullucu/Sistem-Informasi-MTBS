...
public class TandaBahayaUmum_Fragment extends Fragment implements View.OnClickListener , Toggler {
   ...
   // footer
    ...
    public static TandaBahayaUmum_Fragment newInstance(PemeriksaanMain_Activity activity){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.checkBox_1 = res.findViewById(R.id.cb_tanda_1) ;
        this.checkBox_2 = res.findViewById(R.id.cb_tanda_2) ;
        this.checkBox_3 = res.findViewById(R.id.cb_tanda_3);
        this.checkBox_4 = res.findViewById(R.id.cb_tanda_4);
        this.checkBox_5 =res.findViewById(R.id.cb_tanda_5) ;
        this.checkBox_6 = res.findViewById(R.id.cb_tanda_6) ;
        this.checkBox_7 = res.findViewById(R.id.cb_tanda_7);
        this.checkBox_8 = res.findViewById(R.id.cb_tanda_8) ;
