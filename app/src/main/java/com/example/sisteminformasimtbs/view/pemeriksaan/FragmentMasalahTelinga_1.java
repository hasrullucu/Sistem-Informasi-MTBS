 ...
 */
public class FragmentMasalahTelinga_1 extends Fragment implements View.OnClickListener , Toggler {
    ...
    public FragmentMasalahTelinga_1() {
        // Required empty public constructor
    }

    public static FragmentMasalahTelinga_1 newInstance(PemeriksaanMain_Activity activity){
        FragmentMasalahTelinga_1 fragmentMasalahTelinga1 = new FragmentMasalahTelinga_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.checkBox_1 = res.findViewById(R.id.cb_telinga_1);
        this.checkBox_2 = res.findViewById(R.id.cb_telinga_2);
        this.checkBox_3 = res.findViewById(R.id.cb_telinga_3);
        this.checkBox_4 = res.findViewById(R.id.cb_telinga_4);
        this.checkBox_5 =res.findViewById(R.id.cb_telinga_5);
        this.checkBox_6 = res.findViewById(R.id.cb_telinga_6);
