 ...
 */
public class FragmentDemam_2 extends Fragment implements View.OnClickListener , Toggler {
    ...
    public FragmentDemam_2() {
        // Required empty public constructor
    }


    public static FragmentDemam_2 newInstance(PemeriksaanMain_Activity activity){
        FragmentDemam_2 result = new FragmentDemam_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.checkBox_6 = res.findViewById(R.id.cb_demam_6) ;
        this.checkBox_7 = res.findViewById(R.id.cb_demam_7) ;
        this.checkBox_8 = res.findViewById(R.id.cb_demam_8);
        this.checkBox_9 = res.findViewById(R.id.cb_demam_9);
        this.checkBox_10 =res.findViewById(R.id.cb_demam_10) ;
