 ...
 */
public class FragmentStatusHIV_1 extends Fragment implements View.OnClickListener , Toggler {
    ...
    public static final int ID_TOPIK = 8 ;


    public FragmentStatusHIV_1() {
        // Required empty public constructor
    }

    public static FragmentStatusHIV_1 newInstance(PemeriksaanMain_Activity activity){
        FragmentStatusHIV_1 result = new FragmentStatusHIV_1();
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View res = inflater.inflate(R.layout.status_hiv1, container, false);
        ...
        this.checkBox_1 = res.findViewById(R.id.cb_hiv_1) ;
        this.checkBox_2 = res.findViewById(R.id.cb_hiv_2) ;
        this.checkBox_3 = res.findViewById(R.id.cb_hiv_3);
        this.checkBox_4 = res.findViewById(R.id.cb_hiv_4);
        this.checkBox_5 =res.findViewById(R.id.cb_hiv_5) ;
        this.checkBox_6 = res.findViewById(R.id.cb_hiv_6) ;
