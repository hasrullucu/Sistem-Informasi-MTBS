 ...
 */
public class FragmentDataDiri_3 extends Fragment implements View.OnClickListener{
    ...
    public FragmentDataDiri_3() {
        // Required empty public constructor
    }

    public static FragmentDataDiri_3 newInstance(PemeriksaanMain_Activity activity){
        FragmentDataDiri_3 res = new FragmentDataDiri_3();
