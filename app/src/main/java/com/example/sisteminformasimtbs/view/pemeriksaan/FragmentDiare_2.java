 ...
 */
public class FragmentDiare_2 extends Fragment implements View.OnClickListener , Toggler {
    ...
    public FragmentDiare_2() {
        // Required empty public constructor
    }

    public static FragmentDiare_2 newInstance(PemeriksaanMain_Activity activity){
        FragmentDiare_2 fragmentDiare2 = new FragmentDiare_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.checkBox_7 = res.findViewById(R.id.cb_diare_7) ;
        this.checkBox_8 = res.findViewById(R.id.cb_diare_8) ;
        this.checkBox_9 = res.findViewById(R.id.cb_diare_9);
        this.checkBox_10 = res.findViewById(R.id.cb_diare_10);
        this.checkBox_11= res.findViewById(R.id.cb_diare_11);
        this.checkBox_12= res.findViewById(R.id.cb_diare_12);
