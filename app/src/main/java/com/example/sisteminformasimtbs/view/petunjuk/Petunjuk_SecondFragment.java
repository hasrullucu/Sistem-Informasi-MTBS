 ...
 *
 */
public class Petunjuk_SecondFragment extends Fragment implements View.OnClickListener {
    ...
    public Petunjuk_SecondFragment() {
    ...
    public static Petunjuk_SecondFragment newInstance(String param1, String param2) {
        Petunjuk_SecondFragment fragment = new Petunjuk_SecondFragment();
