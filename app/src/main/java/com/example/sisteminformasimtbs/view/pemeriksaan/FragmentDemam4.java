 ...
 */
public class FragmentDemam4 extends Fragment implements View.OnClickListener , Toggler {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.checkBox_16 = res.findViewById(R.id.cb_21) ;
        this.checkBox_17 = res.findViewById(R.id.cb_22) ;
        this.checkBox_18= res.findViewById(R.id.cb_18);
        this.checkBox_19 = res.findViewById(R.id.cb_19);
        this.checkBox_20 =res.findViewById(R.id.cb_20) ;
    ...
    public static FragmentDemam4 newInstance(PemeriksaanMain activity){
        // Required empty public constructor
        FragmentDemam4 result = new FragmentDemam4();
