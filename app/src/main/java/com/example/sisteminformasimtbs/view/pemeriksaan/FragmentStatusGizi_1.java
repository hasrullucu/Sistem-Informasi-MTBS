 ...
 */
public class FragmentStatusGizi_1 extends Fragment implements View.OnClickListener , Toggler {
    ...
    public FragmentStatusGizi_1() {
        // Required empty public constructor
    }

    public static FragmentStatusGizi_1 newInstance(PemeriksaanMain_Activity activity){
        FragmentStatusGizi_1 result = new FragmentStatusGizi_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View res = inflater.inflate(R.layout.fragment_fragment_status_gizi_1, container, false);
        ...
        this.checkBox_1 = res.findViewById(R.id.cb_gizi_1) ;
        this.checkBox_2 = res.findViewById(R.id.cb_gizi_2) ;
        this.checkBox_3 = res.findViewById(R.id.cb_gizi_3);
        this.checkBox_4 = res.findViewById(R.id.cb_gizi_4);
