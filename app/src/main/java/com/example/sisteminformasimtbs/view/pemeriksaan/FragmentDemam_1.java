 ...
 */
public class FragmentDemam_1 extends Fragment implements View.OnClickListener , Toggler {
    ...
    public FragmentDemam_1() {
        // Required empty public constructor
    }

    public static FragmentDemam_1 newInstance(PemeriksaanMain_Activity activity){
        FragmentDemam_1 result = new FragmentDemam_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.checkBox_1 = res.findViewById(R.id.cb_demam_1) ;
        this.checkBox_2 = res.findViewById(R.id.cb_demam_2) ;
        this.checkBox_3 = res.findViewById(R.id.cb_demam_3);
        this.checkBox_4 = res.findViewById(R.id.cb_demam_4);
        this.checkBox_5 =res.findViewById(R.id.cb_demam_5 ) ;
