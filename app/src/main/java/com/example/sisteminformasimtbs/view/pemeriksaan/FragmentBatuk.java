...
public class FragmentBatuk extends Fragment implements View.OnClickListener, Toggler {
    ...
    public FragmentBatuk() {
        // Required empty public constructor
    }

    public static FragmentBatuk newInstance(PemeriksaanMain_Activity activity) {
        FragmentBatuk result = new FragmentBatuk();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View res = inflater.inflate(R.layout.fragment_batuk, container, false);
        ...
        this.checkBox_1 = res.findViewById(R.id.cb_batuk_1);
        this.checkBox_2 = res.findViewById(R.id.cb_batuk_2);
        this.checkBox_3 = res.findViewById(R.id.cb_batuk_3);
        this.checkBox_4 = res.findViewById(R.id.cb_batuk_4  );
