 ...
 */
public class FragmentDemam_5 extends Fragment implements View.OnClickListener , Toggler {
    ...
    public FragmentDemam_5() {
        // Required empty public constructor
    }
    public static FragmentDemam_5 newInstance(PemeriksaanMain_Activity activity){
        // Required empty public constructor
        FragmentDemam_5 result = new FragmentDemam_5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.checkBox_21 = res.findViewById(R.id.cb_demam_21) ;
        this.checkBox_22 = res.findViewById(R.id.cb_demam_22) ;
